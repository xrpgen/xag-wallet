  ...
  >
    <div slot="icon" class="strength-wrapper" v-if="rankText">
      ...
      <div
        ...
        :key="index"
        :style="{backgroundColor:selectIndex>=item.index?backgroundColor:''}"
      ></div>
    </div>
  </van-field>
</template>
      ...
      return [
        {
          reg: "\\S{1,6}$",
          color: "#FF4949",
          rank: this.$t("common.weak"),
          index: 3
        },
        {
          reg: "\\S{8,10}$",
          color: "#ffca59",
          rank: this.$t("common.middle"),
          index: 2
        },
        {
          reg: "\\S{10,14}$",
          color: "#20A0FF",
          rank: this.$t("common.strong"),
          index: 1
        },
        {
          reg: "\\S{14,999}$",
          color: "#41b883",
          rank: this.$t("common.best"),
          index: 0
        }
      ];
    }
