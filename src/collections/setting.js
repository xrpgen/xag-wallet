...
class Setting {
   ...
   */
  constructor(id,defaultAddress, currencyUnit, network, language, gesturePwd,type) {
    this.id = id;
  ...
  static insertSetting(
    ...
    let setting = new Setting(id,defaultAddress, currencyUnit, network, language, gesturePwd,type);
