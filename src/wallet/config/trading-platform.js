...
export default {
  ...
  [AccountType.ripple]: {
    ...
    'rPVMhWBsfF9iMXYj3aAzJVkPDTFNSyWdKy': {name: 'Bittrex'},
    'rUzWJkXyEtT8ekSSxkBYPqCvHpngcy6Fks': {name: 'Okex'},
    'rwBQoCNf3XyJ2UcjyrVf3nmpGF2tM1etDA': {name: 'Huobi'},
    'rh3fa5cyWhxosMhkLg38i79pJZFQkdiqBP': {name: 'Poloniex'},
