  ...
  computed: {
    ...
    menus() {
      ...
      let menus = [
        ...
        {
          icon: "find.png",
          activeIcon: "find-active.png",
          text: this.$t("find.discovery"),
          link: "news-adv",
          show: true
        },
        {
          icon: "setting.png",
          activeIcon: "setting-active.png",
          text: this.$t("setting.setting"),
          link: "setting",
          show: true
        }
      ];
