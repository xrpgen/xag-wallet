<template>
  <div class="set-tran-pwd">
    ...
    >
      <van-nav-bar :title="$t('wallet.setTranPwdTitle')" @click-left="close">
        <span slot="left">
          <i>
      ...
      <pl-content-block :offsetTop="46">
        <content-block>
          <top-block :title="$t('wallet.setTranPwdTitle')" line-height="45px">
            <img src="static/img/password@3x.png" width="64" height="64" />
          </top-block>
        </content-block>
