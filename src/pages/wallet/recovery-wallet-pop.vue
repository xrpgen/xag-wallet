<template>
  <div class="recovery-wallet">
    ...
    >
      <van-nav-bar left-arrow :title="$t('wallet.recoverWallet')" @click-left="close">
        <span slot="left">
          <i>
      ...
      <pl-content-block :offsetTop="46">
        ...
        ></wallet-text-area>
        <wallet-tip
          :tip="$t('wallet.recoverWalletPwdTip')"
        ...
        <button-bottom>
          <!-- <div class="text-primary text-center" style="padding-bottom:10px;">
            ...
            <span
              ...
              v-text="$t('wallet.oneSecUnderstandMnemonicCode')"
            ></span>
          </div>-->
          <van-button
            size="large"
            round
            type="primary"
            @click="recoveryWallet"
            :text="$t('wallet.immediatelyRecover')"
          ></van-button>
        </button-bottom>
