        ...
        <div class="item-block">
          <pl-block>
            <div style="padding: 0 0 10px;overflow: hidden;">
              ...
              <div class="pull-right">{{selectFee}}&nbsp;sat/b</div>
            </div>
            <van-radio-group v-model="selectFee">
              <van-cell-group>
                <van-cell v-for="(item,index) in frees" :key="index" clickable>
  ...
  computed: {
    ...
    errMsg() {
      return {
        ...
        "inputs and outputs are undefined because no solution was found": this.$t(
          "transaction.balanceTooLowTip"
        ),
